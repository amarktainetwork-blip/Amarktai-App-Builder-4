    ...
    <div data-testid="live-preview" className="h-full flex flex-col">
      <div className="h-9 border-b border-emergent-line bg-emergent-base flex items-center justify-between px-3 shrink-0">
        <div className="flex items-center gap-2">
          <Cpu className="w-3.5 h-3.5 text-emergent-fg3" strokeWidth={1.5} />
          <span className="font-mono text-[11px] text-emergent-fg">Live Preview</span>
          <span className="font-mono text-[10px] text-emergent-fg3 uppercase">
      ...
      {!WEBCONTAINER_KEY && (
        <div className="px-3 py-1.5 border-t border-emergent-line bg-emergent-base/80 font-mono text-[10px] text-emergent-fg3">
